...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 08, 2013 at 01:42 PM
...
INSERT INTO tbl_assignment VALUES('Member', '2', 'return isset($params["project"]) && $params["project"]->isUserInRole("Member");', 'N;');
INSERT INTO tbl_assignment VALUES('Owner', '1', '', 's:0:"";');
...
INSERT INTO tbl_comment VALUES(1, 'Hello', 1, '2013-06-07 14:17:05', 2, '2013-06-07 14:17:05', 2);
...
INSERT INTO tbl_issue VALUES(1, 'Issue 1 @ Project 1', 'Test Issue 1 @ Project 1', 1, 0, 0, 2, 2, '2013-06-07 14:16:57', 2, '2013-06-07 14:16:57', 2);
...
INSERT INTO tbl_project VALUES(1, 'Project 1', 'Test Project 1', '2013-06-07 14:12:02', 1, '2013-06-07 14:12:02', 1);
...
INSERT INTO tbl_project_user_assignment VALUES(1, 1, NULL, NULL, NULL, NULL);
INSERT INTO tbl_project_user_assignment VALUES(1, 2, NULL, NULL, NULL, NULL);
...
INSERT INTO tbl_project_user_role VALUES(1, 1, 'Owner');
INSERT INTO tbl_project_user_role VALUES(1, 2, 'Member');
...
INSERT INTO tbl_user VALUES(1, 'admin@noemail.com', 'admin', '21232f297a57a5a743894a0e4a801fc3', '2013-06-08 13:22:52', '2013-06-02 16:02:51', NULL, '2013-06-02 16:02:51', NULL);
INSERT INTO tbl_user VALUES(2, 'user1@yahoo.com', 'user1', '24c9e15e52afc47c225b757e7bee1f9d', '2013-06-07 14:16:09', '2013-06-07 14:15:14', 1, '2013-06-07 14:15:14', 1);
...
ALTER TABLE `tbl_comment`
  ADD CONSTRAINT tbl_comment_ibfk_4 FOREIGN KEY (create_user_id) REFERENCES tbl_user (id) ON DELETE CASCADE,
  ADD CONSTRAINT tbl_comment_ibfk_3 FOREIGN KEY (issue_id) REFERENCES tbl_issue (id) ON DELETE CASCADE;
